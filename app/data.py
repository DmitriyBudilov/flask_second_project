goals = {"travel": {"title": "Для путешествий", "symbol": "⛱"}, "study": {"title": "Для школы", "symbol": "🏫"}, "work": {"title": "Для работы", "symbol": "🏢"}, "relocate": {"title": "Для переезда", "symbol": "🚜"}, "programming": {"title": "Для программирования", "symbol": "🖥"}}
